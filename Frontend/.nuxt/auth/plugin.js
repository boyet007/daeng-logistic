...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/login","method":"post","propertyName":"data"},"logout":{"url":"/logout","method":"post"},"user":{"url":"/users/login","method":"get","propertyName":"data"}},"tokenRequired":true,"tokenType":"Bearer ","_name":"local"}))
